...
original_enum_init = cast(Any, types.Enum.__init__)


def _patched_enum_init(
    self: types.Enum,
    *enums: str | type[enum.Enum],
    **kw: Any,
) -> None:
    if (
        enums
        and isinstance(enums[0], type)
        and issubclass(enums[0], enum.Enum)
...
types.Enum.__init__ = _patched_enum_init  # type: ignore[method-assign]