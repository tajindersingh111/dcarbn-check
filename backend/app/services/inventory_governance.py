...
_HVO_DISCLOSURE_SPECIFICATIONS = (
    ...
    _HvoDisclosureSpecification(
        reporting_year=2025,
        scope1_method=GovernedCalculationMethod.SCOPE1_MOBILE_HVO_LITRES_2025,
        wtt_method=GovernedCalculationMethod.SCOPE3_CATEGORY3_HVO_WTT_LITRES_2025,
        scope1_factor=HVO_2025_SCOPE1_FACTOR_KG_CO2E_PER_LITRE,
        wtt_factor=HVO_2025_WTT_FACTOR_KG_CO2E_PER_LITRE,
        biogenic_co2_factor=HVO_2025_BIOGENIC_CO2_KG_PER_LITRE,
        source_reference=(
            "https://www.gov.uk/government/publications/"
...
def _build_hvo_2025_disclosure(
    results: list[CalculationResult],
    activity_by_id: dict[UUID, ActivityRecord],
) -> dict[str, object] | None:
