...
from app.services.emission_factors import import_uk_2024_factor_workbook


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Import the official UK Government 2024 flat-format factor workbook."
    )
    parser.add_argument("workbook", type=Path)
    parser.add_argument("--dataset-version", default="2024-v1.1")
    parser.add_argument("--reporting-year", type=int, default=2024)
...
async def run() -> None:
    ...
    metadata = FactorSetImportMetadata(
        ...
        notes=(
            "UK Government 2024 final factor set, October 2024 revision. "
