...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Import the official UK Government 2026 flat-format factor workbook."
    )
    parser.add_argument("workbook", type=Path)
    parser.add_argument("--dataset-version", default="2026")
    parser.add_argument("--reporting-year", type=int, default=2026)
